...
export class TableBodyContentRendererComponent<TData = any> extends BodyContentRendererAbstractComponent<TData, TableBodyContentRendererOptions, TableGridMetadata<BasicGridColumn<TData>>, any>
{
    //######################### constructor #########################
